...
$(WOODPECKER_ISSUER): $(WOODPECKER_HOME)
	test -e $(WOODPECKER_ISSUER) || cp $(WOODPECKER_DEFAULT_ISSUER) $(WOODPECKER_ISSUER)

$(WOODPECKER_ISSUER_KEY): $(WOODPECKER_HOME)
	test -e $(WOODPECKER_ISSUER_KEY) || cp $(WOODPECKER_DEFAULT_ISSUER_KEY) $(WOODPECKER_ISSUER_KEY)
	chmod 0640 $(WOODPECKER_ISSUER_KEY)

$(WOODPECKER_CONFIG): $(WOODPECKER_HOME) $(WOODPECKER_ISSUER) $(WOODPECKER_ISSUER_KEY)
	test -e $(WOODPECKER_CONFIG) || cp $(WOODPECKER_DEFAULT_CONFIG) $(WOODPECKER_CONFIG)
